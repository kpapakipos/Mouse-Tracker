...
class CurrentAdvViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.MickeyCheckBox?.image = self.adventure.activities[indexPath.row].completed ? UIImage(named: "MickeyFilled2") : UIImage(named: "MickeyCheck")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        cell.MickeyCheckBox.image = cell.MickeyCheckBox.image == UIImage(named: "MickeyCheck") ? UIImage(named: "MickeyFilled2") : UIImage(named: "MickeyCheck")
